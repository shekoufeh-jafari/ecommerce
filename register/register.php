    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (mysqli_num_rows($query) == 1) {
            ...
            if ($_SESSION['admin']=='admin@'){
                echo "<pre style='color: black'>";
                echo "this is admin";
            header("Refresh: 1;Url=\"http://localhost/learn/ecommerce/admin\"");
            }else{
                echo "<pre style='color: black'>";
                echo "sign in successful";
                header("Refresh: 1;Url=\"http://localhost/learn/ecommerce\"");
            }
        } else {
            echo "<pre style='color: black'>";
            echo "wrong password or email";
            header("Refresh: 1;Url=\"http://localhost/learn/ecommerce/register/register.php\"");
        }
